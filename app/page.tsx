...
export default function Home() {
  ...
  }, [activeIndex, area, complexity, effectiveKtim, fixedPrice, hourRate, hours, method, pricing, repeat, sections, sketch, sketchPercent, stageP, stagePFactor, stageR, stageRFactor, unitRate, urgency, vat, works]);

  const saveDraft = () => {
    localStorage.setItem("proektsmeta-draft", JSON.stringify({ type, title, location, area, capacity, sections, method, stageP, stageR, sketch, sketchPercent, index, vat, repeat, complexity, urgency, works }));
