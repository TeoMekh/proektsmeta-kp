...
export default function Home() {
  ...
  }, [area, complexity, fixedPrice, hourRate, hours, index, method, pricing, repeat, sections, selectedKtim, sketch, stageP, stageR, unitRate, urgency, vat, works]);
