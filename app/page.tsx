...
export default function Home() {
  ...
  const toggleWork = (id: string) => { setDistributionSourceP("manual"); setDistributionSourceR("manual"); setWorks(list => list.map(w => w.id === id ? { ...w, enabled: !w.enabled } : w)); };
