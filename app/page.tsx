...
export default function Home() {
  ...
  const calc = useMemo(() => {
    ...
    const ep = sketch ? base * .2 * (method === "normative" ? activeIndex : 1) : 0;
  ...
  }, [activeIndex, area, complexity, effectiveKtim, fixedPrice, hourRate, hours, method, pricing, repeat, sections, sketch, stageP, stagePFactor, stageR, stageRFactor, unitRate, urgency, vat, works]);
